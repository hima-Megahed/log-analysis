...
def popular3_articles():
    """This method will return most 3 popular articles"""
    #question 1
    ...
    for _article in articles:
        print("Article slug is: " + str(_article[0]), str(_article[1]) + " views.")
...
def bad_requests_percentage():
    ...
    for request in requests:
        print("Request day: "+str(request[0]),"Error Rate: "+str(round(request[1],2)))
